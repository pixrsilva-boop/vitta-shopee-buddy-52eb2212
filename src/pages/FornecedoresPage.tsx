...
const STORAGE_KEY = "vitta-fornecedores";
  ...
  const save = () => {
    ...
    if (editing) {
      setSuppliers((prev) =>
        prev.map((s) =>
          s.id === editing.id
            ? { ...s, name: name.trim(), categories, phone, location, notes }
            : s
        )
      );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 font-medium">
            Cadastre e contate seus fornecedores rapidamente.
          </p>
        </div>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input value={name} onChange={(e) => setName(e.target.value)} placeholder="Ex: Textil São Paulo" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input value={location} onChange={(e) => setLocation(e.target.value)} placeholder="Ex: Brás, São Paulo" />
            </div>
            <div className="space-y-2">
              <Label>Observações</Label>
              <Textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Anotações sobre o fornecedor..." rows={3} />
            </div>
          </div>
          <DialogFooter>
