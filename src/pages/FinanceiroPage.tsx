...
const FinanceiroPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
        ...
        <TabsContent value="expense">
          <Card className="border-none shadow-md">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={addExpense} variant="destructive" className="w-full md:w-auto">Adicionar Despesa</Button>
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="income">
          <Card className="border-none shadow-md">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={addIncome} className="w-full md:w-auto bg-success text-success-foreground hover:bg-success/90">Adicionar Receita</Button>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
      ...
      {/* History */}
      <Card className="border-none shadow-md">
        <CardHeader><CardTitle className="text-lg text-secondary">📜 Extrato</CardTitle></CardHeader>
        <CardContent>
          {transactions.length === 0 ? (
            <p className="text-center text-muted-foreground py-8">Nenhum lançamento ainda.</p>
          ) : (
            <Table>
              <TableHeader><TableRow><TableHead className="w-10"></TableHead><TableHead>Descrição</TableHead><TableHead className="hidden md:table-cell">Categoria</TableHead><TableHead className="hidden md:table-cell">Data</TableHead><TableHead className="text-right">Valor</TableHead><TableHead className="w-10"></TableHead></TableRow></TableHeader>
              <TableBody>
                {transactions.map((t) => (
                  <TableRow key={t.id}>
