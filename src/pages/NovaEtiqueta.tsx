...
// O PARSER V7 (Focado em ler a Tabela da Página 2)
function parse(lines: string[]): LabelData {
  ...
  // ==============================================================
  // TABELA DE PRODUTOS (Foco total na Página 2)
  // ==============================================================
  let totalQtd = 1;
  let totalVal = "R$ 0,00";
  ...
  if (fullText.includes("Nenhum produto extraido") || fullText.includes("Nenhum produto extraído")) {
      ...
      // Captura tudo entre "VALOR" ou "Conteúdo" até chegar ao "Peso Total", "Assinatura" ou "Declaro"
...
/* ───── Component ───── */
// ATENÇÃO: O NOME É NovaEtiqueta, por isso o App.tsx vai reconhecê-lo perfeitamente!
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-blue-600">Teste V7 AZUL - PÁGINA 2</p>
          </div>
        </div>
